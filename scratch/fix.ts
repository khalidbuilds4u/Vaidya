...
function mapToMainSpecialty(oldName: string): string {
  ...
  if (lower.includes("gastro") || lower.includes("stomach")) return "Gastroenterology";
  if (lower.includes("transplant") || lower.includes("liver") || lower.includes("kidney")) return "Organ Transplant";
  if (lower.includes("cosmetic") || lower.includes("plastic")) return "Cosmetic Surgery";
  if (lower.includes("dent") || lower.includes("teeth")) return "Dental";

...
export function Header() {
  ...
  return (
    <motion.header 
      ...
      className="sticky top-0 z-50 w-full bg-white/75 dark:bg-slate-950/80 backdrop-blur-xl border-b border-white/50 dark:border-slate-800/50 shadow-[0_4px_20px_rgba(15,118,110,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.2)] transition-all duration-300"
    >
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-2.5 group" onClick={closeMenu}>
            ...
            <div className="flex flex-col justify-center">
              <span className="text-base sm:text-xl tracking-tight leading-none whitespace-nowrap">
                <span className="font-extrabold text-violet-700 dark:text-violet-400">Asad</span>
        ...
        <nav className="hidden md:flex flex-wrap items-center gap-1 xl:gap-2 text-xs xl:text-sm font-medium">
          <Link href="/" className="px-2 xl:px-3 py-1.5 rounded-full text-slate-700 dark:text-slate-200 hover:text-primary dark:hover:text-primary hover:bg-primary/5 transition-all whitespace-nowrap">
            {t('home')}
          </Link>
          <Link href="/hospitals" className="px-2 xl:px-3 py-1.5 rounded-full text-slate-700 dark:text-slate-200 hover:text-primary dark:hover:text-primary hover:bg-primary/5 transition-all">
            {t('hospitals')}
          </Link>
          ...
          <Link href="/services" className="px-2 xl:px-3 py-1.5 rounded-full text-slate-700 dark:text-slate-200 hover:text-primary dark:hover:text-primary hover:bg-primary/5 transition-all">
            {t('services')}
          </Link>
          <Link href="/blogs" className="px-2 xl:px-3 py-1.5 rounded-full text-slate-700 dark:text-slate-200 hover:text-primary dark:hover:text-primary hover:bg-primary/5 transition-all">
            {t('blogs')}
          </Link>
          <Link href="/about-us" className="px-2 xl:px-3 py-1.5 rounded-full text-slate-700 dark:text-slate-200 hover:text-primary dark:hover:text-primary hover:bg-primary/5 transition-all whitespace-nowrap">
            {t('aboutUs')}
          </Link>
          <Link href="/contact-us" className="px-2 xl:px-3 py-1.5 rounded-full text-slate-700 dark:text-slate-200 hover:text-primary dark:hover:text-primary hover:bg-primary/5 transition-all whitespace-nowrap">
            {t('contactUs')}
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-1 sm:gap-3 shrink-0">
          ...
          {/* Mobile Menu Toggle */}
          <button 
            className="md:hidden p-2 rounded-lg text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary hover:bg-primary/5 transition-colors"
            onClick={toggleMenu}
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 w-full max-h-[calc(100vh-4rem)] overflow-y-auto bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl border-b border-slate-200/80 dark:border-slate-800/80 shadow-2xl p-5 flex flex-col gap-4 animate-in slide-in-from-top-4 duration-300 z-50">
          <div className="pb-2 border-b border-slate-100 dark:border-slate-800 flex items-center gap-2 text-xs font-bold text-primary">
          ...
          <nav className="flex flex-col gap-1 text-base font-medium">
            ...
            <Link href="/about-us" className="py-2.5 px-3 rounded-lg dark:text-slate-200 hover:bg-primary/5 hover:text-primary dark:hover:text-primary transition-colors" onClick={closeMenu}>{t('aboutUs')}</Link>
            <Link href="/contact-us" className="py-2.5 px-3 rounded-lg dark:text-slate-200 hover:bg-primary/5 hover:text-primary dark:hover:text-primary transition-colors" onClick={closeMenu}>{t('contactUs')}</Link>
            <a 

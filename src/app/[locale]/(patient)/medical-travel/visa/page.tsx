...
import { MedicalVisaContent } from '@/components/patient/medical-travel/MedicalVisaContent';

export const metadata: Metadata = {
  title: 'Medical Visa Assistance | AsadHealthcare',
  description: 'Hassle-free medical visa assistance to India.',
};
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-4 sm:mb-6 leading-[1.15] text-white">
              Hassle-Free <br className="hidden sm:inline" />
